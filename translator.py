...
team_file = 'team_file.xlsx'
excel = 'schedule.xlsx'

def main(excel_file):
    wb = xl.load_workbook(excel_file, data_only=True) # Open Workbook
...
def translator(team_file, managers):
    # Delete used/unnecessary information
    #cells.clear()
    #excel_dates.clear()

    wb1 = xl.load_workbook(team_file)
...
#translator('team_file.xlsx', managers)
